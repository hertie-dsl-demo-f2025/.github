...
# Deep Learning (Demo) - semester control repo

This is the **`.github` repo** for the `hertie-dsl-demo-f2025` semester org. **Students and instructors rarely need to touch anything in this repo directly.**
